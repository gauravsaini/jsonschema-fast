...
from jsonschema_fast import _utils

if TYPE_CHECKING:
    from collections.abc import Iterable, Mapping, MutableMapping, Sequence

    from jsonschema_fast import _types
...
class _RefResolutionError(Exception):  # noqa: PLW1641
    ...
    _DEPRECATION_MESSAGE = (
        "jsonschema_fast.exceptions.RefResolutionError is deprecated as of version "
    ...
    def __eq__(self, other):
        if self.__class__ is not other.__class__:
            return NotImplemented  # pragma: no cover -- uncovered but deprecated
...
class _WrappedReferencingError(_RefResolutionError, _Unresolvable):  # pragma: no cover -- partially uncovered but to be removed
...
.. code:: python
    ...
    sorted(validator.iter_errors(12), key=jsonschema_fast.exceptions.relevance)
"""
