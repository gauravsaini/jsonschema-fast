"""
typing.Protocol classes for jsonschema_fast interfaces.
"""
...
# it needs to see names like `jsonschema_fast.TypeChecker`
# therefore, only import at type-checking time (to avoid circular references),
# but use `jsonschema_fast` for any types which will otherwise not be resolvable
if TYPE_CHECKING:
    from collections.abc import Iterable, Mapping

    import referencing.jsonschema

    from jsonschema_fast import _typing
    from jsonschema_fast.exceptions import ValidationError
...
class Validator(Protocol):
    ...
    Arguments:
        ...
        format_checker:
            ...
            *no* format validation is done, and the presence of format
            ...
            against instances. Ensure you've installed `jsonschema_fast` with
    ...
    #: A `jsonschema_fast.TypeChecker` that will be used when validating
    #: :kw:`type` keywords in JSON schemas.
    TYPE_CHECKER: ClassVar[jsonschema_fast.TypeChecker]

    #: A `jsonschema_fast.FormatChecker` that will be used when validating
    #: :kw:`format` keywords in JSON schemas.
    FORMAT_CHECKER: ClassVar[jsonschema_fast.FormatChecker]
    ...
    def __init__(
        ...
        format_checker: jsonschema_fast.FormatChecker | None = None,
        *,
    ...
    def is_type(self, instance: Any, type: str) -> bool:
        ...
        Raises:
            ...
            `jsonschema_fast.exceptions.UnknownType`:
