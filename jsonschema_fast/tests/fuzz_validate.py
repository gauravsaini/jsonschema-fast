...
See https://github.com/google/oss-fuzz/tree/master/projects/jsonschema_fast for the
...
def test_schemas(obj1, obj2):
    try:
        jsonschema_fast.validate(instance=obj1, schema=obj2)
    except jsonschema_fast.exceptions.ValidationError:
        pass
    except jsonschema_fast.exceptions.SchemaError:
        pass
