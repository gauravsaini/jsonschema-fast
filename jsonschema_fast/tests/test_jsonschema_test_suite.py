...
TestDraft3 = DRAFT3.to_unittest_testcase(
    ...
    Validator=jsonschema_fast.Draft3Validator,
    format_checker=jsonschema_fast.Draft3Validator.FORMAT_CHECKER,
    skip=lambda test: (
        ecmascript_regex(test)
        or missing_format(jsonschema_fast.Draft3Validator)(test)
...
TestDraft4 = DRAFT4.to_unittest_testcase(
    ...
    format_checker=jsonschema_fast.Draft4Validator.FORMAT_CHECKER,
    skip=lambda test: (
        ecmascript_regex(test)
        or leap_second(test)
        or missing_format(jsonschema_fast.Draft4Validator)(test)
        or complex_email_validation(test)
...
TestDraft6 = DRAFT6.to_unittest_testcase(
    ...
    Validator=jsonschema_fast.Draft6Validator,
    format_checker=jsonschema_fast.Draft6Validator.FORMAT_CHECKER,
    skip=lambda test: (
        ecmascript_regex(test)
        or leap_second(test)
        or missing_format(jsonschema_fast.Draft6Validator)(test)
        or complex_email_validation(test)
        or hostname_validation(test)
    ),
)
...
TestDraft7 = DRAFT7.to_unittest_testcase(
    ...
    Validator=jsonschema_fast.Draft7Validator,
    format_checker=jsonschema_fast.Draft7Validator.FORMAT_CHECKER,
    skip=lambda test: (
        ecmascript_regex(test)
        or leap_second(test)
        or missing_format(jsonschema_fast.Draft7Validator)(test)
        or complex_email_validation(test)
        or hostname_validation(test)
...
TestDraft201909 = DRAFT201909.to_unittest_testcase(
    ...
    Validator=jsonschema_fast.Draft201909Validator,
    skip=skip(
...
TestDraft201909Format = DRAFT201909.to_unittest_testcase(
    ...
    Validator=jsonschema_fast.Draft201909Validator,
    format_checker=jsonschema_fast.Draft201909Validator.FORMAT_CHECKER,
    skip=lambda test: (
        ...
        or leap_second(test)
        or missing_format(jsonschema_fast.Draft201909Validator)(test)
...
TestDraft202012 = DRAFT202012.to_unittest_testcase(
    ...
    Validator=jsonschema_fast.Draft202012Validator,
    skip=lambda test: (
        skip(
            message="Vocabulary support is still in-progress.",
            subject="vocabulary",
...
TestDraft202012Format = DRAFT202012.to_unittest_testcase(
    ...
    Validator=jsonschema_fast.Draft202012Validator,
    format_checker=jsonschema_fast.Draft202012Validator.FORMAT_CHECKER,
    skip=lambda test: (
        complex_email_validation(test)
        or hostname_validation(test)
        or idn_hostname_validation(test)
        or ecmascript_regex(test)
        or leap_second(test)
        or missing_format(jsonschema_fast.Draft202012Validator)(test)
        or duration_validation(test)
    ),
)
