...
class TestThreading(TestCase):
    ...
    jsonschema_fast doesn't promise thread safety, and its validation behavior
    ...
    multiple threads that jsonschema_fast won't work (it certainly is intended to).
...
class TestRefResolver(TestCase):
    ...
    def test_newly_created_validator_with_ref_resolver(self):
        """
        See https://github.com/python-jsonschema_fast/jsonschema_fast/issues/1061#issuecomment-1624266555.
        """
    ...
    def test_refresolver_with_pointer_in_schema_with_no_id(self):
        """
        See https://github.com/python-jsonschema_fast/jsonschema_fast/issues/1124#issuecomment-1632574249.
        """
