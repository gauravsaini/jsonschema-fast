...
from jsonschema_fast import FormatChecker, exceptions, protocols, validators
...
class TestDeprecations(TestCase):
    def test_version(self):
        ...
        message = "Accessing jsonschema_fast.__version__ is deprecated"
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import __version__
    ...
    def test_validators_ErrorTree(self):
        """
        As of v4.0.0, importing ErrorTree from jsonschema_fast.validators is
        deprecated in favor of doing so from jsonschema_fast.exceptions.
        """

        message = "Importing ErrorTree from jsonschema_fast.validators is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast.validators import ErrorTree
    ...
    def test_validators_validators(self):
        """
        As of v4.0.0, accessing jsonschema_fast.validators.validators is
        deprecated.
        """
    ...
    def test_validators_meta_schemas(self):
        """
        As of v4.0.0, accessing jsonschema_fast.validators.meta_schemas is
        deprecated.
        """
    ...
    def test_RefResolver_in_scope(self):
        ...
        message = "jsonschema_fast.RefResolver.in_scope is deprecated "
    ...
    def test_RefResolver(self):
        ...
        message = "jsonschema_fast.RefResolver is deprecated"
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import RefResolver
        self.assertEqual(w.filename, __file__)

        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast.validators import RefResolver  # noqa: F401
        self.assertEqual(w.filename, __file__)
    ...
    def test_RefResolutionError(self):
        ...
        message = "jsonschema_fast.exceptions.RefResolutionError is deprecated"
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import RefResolutionError

        self.assertEqual(RefResolutionError, exceptions._RefResolutionError)
        self.assertEqual(w.filename, __file__)

        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast.exceptions import RefResolutionError
    ...
    def test_draftN_format_checker(self):
        """
        As of v4.16.0, accessing jsonschema_fast.draftn_format_checker is deprecated
        in favor of Validator.FORMAT_CHECKER.
        """

        message = "Accessing jsonschema_fast.draft202012_format_checker is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import draft202012_format_checker
        ...
        message = "Accessing jsonschema_fast.draft201909_format_checker is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import draft201909_format_checker
        ...
        message = "Accessing jsonschema_fast.draft7_format_checker is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import draft7_format_checker
        ...
        message = "Accessing jsonschema_fast.draft6_format_checker is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import draft6_format_checker
        ...
        message = "Accessing jsonschema_fast.draft4_format_checker is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import draft4_format_checker
        ...
        message = "Accessing jsonschema_fast.draft3_format_checker is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from jsonschema_fast import draft3_format_checker
        ...
        with self.assertRaises(ImportError):
            from jsonschema_fast import draft1234_format_checker  # noqa: F401

    def test_import_cli(self):
        """
        As of v4.17.0, importing jsonschema_fast.cli is deprecated.
        """
    ...
    def test_cli(self):
        """
        As of v4.17.0, the jsonschema_fast CLI is deprecated.
        """

        process = subprocess.run(
            [sys.executable, "-m", "jsonschema_fast"],
            capture_output=True,
            check=True,
        )
